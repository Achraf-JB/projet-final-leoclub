...
<body>
    <div class="container">
        ...
        <img src="https://zupimages.net/up/23/21/7ics.jpg " alt="header-image" class="cld-responsive" >
                <h1 class="form-title">Hiver Au Chaud</h1>
                <form method="POST" action="">
                   <input type="text" required name ="name" placeholder="NAME">
                <div class="beside">
                    <input type="tel" required name ="number" placeholder="PHONE NUMBER">
...
$email = $_POST["email"];
				...
				$requete = "INSERT INTO hiver values ('$name','$phone','$option','$email')";
